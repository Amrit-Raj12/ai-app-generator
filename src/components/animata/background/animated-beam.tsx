...
//                 animationDelay: `${index * 0.5}s`, // ✅ this works correctly
//             }}
//         >
//             <div
//                 style={{
...
function Beam({ index }: { index: number }) {
  ...
  style={{
    width: "6px",
    transform: "translateY(-20%)",
    animationDelay: `${index * 0.5}s`, // ✅ Required for staggered animation
    animationDuration: flag ? "7s" : "11s", // ✅ Use style instead of --duration
  }}
    >
      <div
        style={{
